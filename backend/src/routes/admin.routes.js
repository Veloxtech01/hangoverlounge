...
import { createEvent, activateEvent, listEvents, seatStatus, unassignSeat, listCodes } from '../controllers/admin.controller.js';
...
adminRouter.post('/events/:eventId/seats/:seatNumber/unassign', unassignSeat);
